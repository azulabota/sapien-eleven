    ...
    <div className="relative w-full max-w-lg mx-auto" style={{ height: 280 }}>
      <svg viewBox="0 0 480 280" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <g style={{ animation: 'float-node 5s ease-in-out infinite' }}>
          ...
          <text x="58" y="130" fill="rgba(140,140,140,0.5)" fontSize="7" fontFamily="Plus Jakarta Sans, sans-serif" letterSpacing="1">WEARABLES</text>
        </g>
        ...
        <g style={{ animation: 'float-node 6s ease-in-out infinite', animationDelay: '-2s' }}>
          ...
          <text x="350" y="118" fill="rgba(140,140,140,0.5)" fontSize="7" fontFamily="Plus Jakarta Sans, sans-serif" letterSpacing="1">NUTRITION</text>
        </g>
        ...
        <g style={{ animation: 'float-node 7s ease-in-out infinite', animationDelay: '-1s' }}>
          ...
          <text x="65" y="258" fill="rgba(140,140,140,0.5)" fontSize="7" fontFamily="Plus Jakarta Sans, sans-serif" letterSpacing="1">WORKOUTS</text>
        </g>
        ...
        <g style={{ animation: 'float-node 4.5s ease-in-out infinite', animationDelay: '-3s' }}>
          ...
          <text x="348" y="258" fill="rgba(140,140,140,0.5)" fontSize="7" fontFamily="Plus Jakarta Sans, sans-serif" letterSpacing="1">SLEEP</text>
        </g>
        ...
        <g style={{ animation: 'float-node 5.5s ease-in-out infinite', animationDelay: '-0.5s' }}>
          ...
          <text x="220" y="178" fill="rgba(140,140,140,0.4)" fontSize="7" fontFamily="Plus Jakarta Sans, sans-serif" letterSpacing="1">MOOD</text>
        </g>

        {/* Broken connection indicators — red severed lines */}
        <line x1="100" y1="80" x2="160" y2="120" stroke="rgba(202,60,61,0.25)" strokeWidth="0.8" strokeDasharray="2 6" />
        <line x1="340" y1="80" x2="280" y2="120" stroke="rgba(202,60,61,0.25)" strokeWidth="0.8" strokeDasharray="2 6" />
        <line x1="120" y1="200" x2="200" y2="160" stroke="rgba(202,60,61,0.25)" strokeWidth="0.8" strokeDasharray="2 6" />
        <line x1="340" y1="200" x2="270" y2="160" stroke="rgba(202,60,61,0.25)" strokeWidth="0.8" strokeDasharray="2 6" />

        {/* X marks on broken connections */}
        <text x="136" y="106" fill="rgba(202,60,61,0.5)" fontSize="8">✕</text>
        <text x="305" y="106" fill="rgba(202,60,61,0.5)" fontSize="8">✕</text>
        <text x="157" y="183" fill="rgba(202,60,61,0.5)" fontSize="8">✕</text>
        <text x="302" y="183" fill="rgba(202,60,61,0.5)" fontSize="8">✕</text>
      </svg>
    </div>
  );
}
